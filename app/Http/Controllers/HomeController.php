...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $data = [
            ...
            'pageType' => 'home',
            'heroSubtitle' => 'Ceylon 1850 is',
            'heroTitle' => 'An Extraordinary Experience',
            'heroDescription' => 'Step into living heritage at Ceylon 1850 in Udawalawe — a hands-on village experience crafted by local families. From your cinnamon-tea welcome to the stories behind our crafts and cuisine, every moment is authentic, relaxed, and memorable.',
